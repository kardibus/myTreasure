...
public class ControllerModel {
    ...
    public String createBrand(@RequestParam(name = "model") String modelstr, Model model){
        com.example.myTreasure.domain.Model model1=new com.example.myTreasure.domain.Model(modelstr);
    ...
    public String updateBrand(@PathVariable(value = "id",required = false) com.example.myTreasure.domain.Model modelId,
