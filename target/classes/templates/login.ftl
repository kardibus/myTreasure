                        ...
                        <div class="tab" role="tabpanel">
                                ...
                                <div class="tab-content tabs">
                                        <div role="tabpanel" class="tab-pane fade in active" id="Section1">
                                                ...
                                                <form class="form-horizontal" method="get" action="/emailforgot" enctype="multipart/form-data">
                                                        <div class="form-group forgot-pass">
                                                                <button type="submit" class="btn btn-default" id="btn-get">forgot password</button>
                                                        </div>
                                                </form>
                                        </div>
                                        <div role="tabpanel" class="tab-pane fade" id="Section2">
                                                <form method="post" action="/registration" enctype="multipart/form-data" class="form-horizontal">
                                                        <div class="form-group">
